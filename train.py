...
def add_arguments(args):
    ...
    args.add_argument('--input_dim', type=int, help="input dimension", default=768)# 默认768
    args.add_argument('--out_dim', type=int, help="output dimension", default=768)# 默认768
...
if __name__ == "__main__":
    ...
    if args.eval_dir is not None:
        ...
        eval_data = train_data[int(len(train_data)*0.7):]#默认0.7
        train_data = train_data[:int(len(train_data)*0.7)]#默认0.7
    ...
    for epoch_num in range(args.epochs):
        ...
        for tmp_train in tqdm(train_data):
            ...
            # node_outputs=node_outputs[:,0:512]
